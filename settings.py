...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/cyrus/AmpliFire/databases/db1',                      # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
    '/home/cyrus/AmpliFire/templates/'
)
...
DEFAULT_FROM_EMAIL = 'webmaster@jaycall.com'
