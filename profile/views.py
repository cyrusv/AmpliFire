...
def create_profile(request, template_name='profiles/create_profile.html'):
	print "yay1"
	try:
...
def edit_profile(request, form_class=None, success_url=None,
    ...
    return render_to_response(template_name, { 'form': form, 'profile': profile_obj, }, context_instance=RequestContext(request))
